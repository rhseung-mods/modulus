...
data class ToolAction(
    val name: String,
    val action: (ItemUsageContext) -> ActionResult
) : Translatable {
    init {
    ...
    companion object {
        ...
        private fun shouldCancelStripAttempt(player: PlayerEntity?, hand: Hand): Boolean {
        ...
        val STRIP = ToolAction("strip") { context ->
            ...
            if (shouldCancelStripAttempt(player, hand)) {
                return@ToolAction ActionResult.PASS;
            }
                ...
                return@ToolAction ActionResult.SUCCESS;
            }
        };
        ...
        val DECREASE_OXIDATION = ToolAction("decrease_oxidation") { context ->
            val world = context.world;
            val blockPos = context.blockPos;
            val player = context.player;
            val hand = context.hand;
        ...
        val REMOVE_WAX = ToolAction("remove_wax") { context ->
            val world = context.world;
            val blockPos = context.blockPos;
            val player = context.player;
            val hand = context.hand;
        ...
        val TILL = ToolAction("till") { context ->
            val world = context.world;
            val blockPos = context.blockPos;
            val state = world.getBlockState(blockPos);
            val (condition, consumer) = TILLING_MAP[state.block] ?: return@ToolAction ActionResult.PASS;
        ...
        val PATH = ToolAction("path") { context ->
            val world = context.world;
            val blockPos = context.blockPos;
            val state = world.getBlockState(blockPos);
            val player = context.player;
        ...
        val CAMPFIRE_EXTINGUISH = ToolAction("campfire_extinguish") { context ->
            val world = context.world;
            val blockPos = context.blockPos;
            val state = world.getBlockState(blockPos);
            val player = context.player;
